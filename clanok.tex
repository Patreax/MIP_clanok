...
OOWS metóda je v tejto časti vynechaná, pretože implementácia MDA je pri objektovo-orientovaných metódach čiastočne podobná (napr. obidve využívajú externé nástroje), a preto bude popísaná len OOHDM metóda.\\
...
\\
Tu bude porovannie a tabulka

\begin{figure*}[tbh]
\centering
\includegraphics[scale=0.6]{./Visuals/OOHDMDA VS WSDMDA.png}
