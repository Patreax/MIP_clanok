...
\begin{figure*}[tbh]
\centering
\includegraphics[scale=0.8]{./Visuals/Tabulka OOHDM.png}
...
\begin{figure*}[tbh]
\centering
\includegraphics[scale=0.8]{./Visuals/Tabulka OOWS.png}
...
\begin{figure*}[tbh]
\centering
\includegraphics[scale=0.8]{./Visuals/Tabulka WSDM.png}
...
Primárnou úlohou tejto práce je popísať a porovnať metódy využívané pri vývoji webových aplikácií. Sekundárnym cieľom je ale priblížiť problematiku modelovania v softvérovom inžinierstve.\\
Analyzované metódy boli OOHDM, OOWS a WSDM. V článku bol taktiež spomenutý populárny MDA prístup spolu s jeho implementáciou na vylepšenie spomenutých metód. Dozvedeli sme sa ako jednotlivé metódy fungujú, aké majú požiadavky a čo je cieľom hybridných metód využívajúcich MDA prístup. Taktiež boli osobitne porovnané tradičné a hybridné metódy. Z týchto porovnaní vyplívajú viaceré fakty. Vieme, že všetky metódy sú zamerané na vývoj webových aplikácií a líšia sa iba v prístupe realizácie tohto cieľa. Rovnako sme zistili, aký užitočný je MDA prístup a aké je jeho využitie. Ide mimovšetkého o transformáciu modelov za účelom presnejšieho špecifikovania technologických požiadaviek systému. Na to slúžia hybridné metódy ako napríklad OOHDMDA a WSDMDA, ktoré kombinujú techniky tradičných metód a obohacujú ich o tie, ktoré sú spomenuté v MDA paradigme.\\
...
Budúce práce budú zamerané na popis a porovananie ďalších metód, využívaných pri vývoji webových aplikácií, ako aj na nové techniky a technológie využívané v tomto obore, ktorý sa veľmi rýchlo rozvíja. 
