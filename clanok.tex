...
Modelmi riadený vývoj (MDD: Model-Driven Developement) sa stáva stále viac a viac dôležitou metódou vrámci softvérového inžinierstva. 

\section{Koncepčné modely} \label{nejaka}
