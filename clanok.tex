...
OOHDMA je modelovacia metóda, ktorá kombinuje vlastnosti OOHDM metódy a prvky MDA prístupu. Jej hlavným cieľom je transformácia koncepčného modelu základnej metódy na PIM model využitím ... Ďalej nasleduje transformáca na PSM model využitím servlet-based dacoho. 
...
Táto metóda prerába koncepčný model tradičnej metódy, za účelom využitia tohto modelu ako PIM model, a to vďaka pridaniu používateľského záujmového profilu. Ďalej kladie veľký dôraz na následnú transformáciu na PSM model, spresnením PIM modelu.    ////cite enhanced WSDM 
